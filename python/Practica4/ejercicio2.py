import json
def modificoDatosExcepciones(nombre):
    try: 
        ...
        nombreNuevo = input("Ingrese de nuevo el nombre del archivo")
        modificoDatosExcepciones(nombreNuevo) 
modificoDatosExcepciones("pepe.txt")